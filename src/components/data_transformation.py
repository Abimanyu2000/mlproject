...
class DataTransformation:
    ...
    def get_data_transformer_object(self,train_df,test_df):
        try:
            ...
            numerical_columns=[col for col in train_df.columns if train_df[col].dtype != 'O' and col != "math_score"]
            ...
            logging.info("Numerical data (scaling) and categorical data (encoding and scaling) pipeline created")
    ...
    def initiate_data_transformation(self,train_path,test_path):
        ...
        try:
            ...
            logging.info("The train and test data read")

            logging.info("obtaining preprocessor object")

            preprocessing_object=self.get_data_transformer_object(train_df,test_df)

            target_column_name = "math_score"
            numerical_columns=[col for col in train_df.columns if train_df[col].dtype != 'O']
            categorical_columns=[col for col in train_df.columns if train_df[col].dtype == 'O']
            ...
            logging.info("Applying preprocessing objects on train and test dataframe")
